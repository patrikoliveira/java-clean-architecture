...
public class UsuarioController {
    ...
    @PutMapping("/{cpf}")
    public UsuarioResponseDto atualizaUsuario(@PathVariable String cpf, @RequestBody UsuarioRequestDto dto) {
        Usuario atualizado = alterarUsuario.alteraDadosUsuario(cpf, new Usuario(dto.cpf(), dto.nome(), dto.nascimento(), dto.email()));
        return new UsuarioResponseDto(atualizado.getCpf(), atualizado.getNome(), atualizado.getNascimento(), atualizado.getEmail());
    }
